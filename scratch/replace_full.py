...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .message-row { display: flex; gap: 12px; max-width: 75%; width: fit-content; align-items: flex-end; }
        ...
        <div class="chat-main-panel">
            ...
            <div class="chat-main-header">
                ...
                <div class="chat-main-header-actions">
                    <button class="icon-btn" title="Voice Call"><i data-lucide="phone"></i></button>
                                        ...
                                        <div class="chat-text-balloon">
                                            ...
                                            <?php if (!empty($msg['attachment_path'])): ?>
                                                <div style="margin-top: 10px; font-size: 12px; display: flex; align-items: center; gap: 6px;">
                                                    ...
                                                    <a href="<?= htmlspecialchars($msg['attachment_path']) ?>" target="_blank" style="color:inherit; text-decoration: underline; font-weight: 600;">Attached File</a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                        ...
                        .then(data => {
                            if (data.status === 'success') {
                                ...
                                if (data.messages.length === 0) {
                                    ...
                                    // Add a date separator for UI richness
                                    ...
                                    data.messages.forEach(msg => {
                                        ...
                                        // Format YYYY-MM-DD HH:mm:ss for safari correctly by replacing spaces with T
...
with open('c:/xampp/htdocs/Research_Digital/dashboards/message.php', 'w') as f:
    f.write(PHP_CODE)
